...
describe('ApMfmService', () => {
	...
	describe('getNoteHtml', () => {
		test('Do not provide _misskey_content for simple text', () => {
			...
			assert.equal(content, '<p>テキスト <a href="http://Acuaskey.local/tags/タグ" rel="tag">#タグ</a> <a href="http://Acuaskey.local/@mention" class="u-url mention">@mention</a> 🍊 ​:emoji:​ <a href="https://example.com">https://example.com</a></p>', 'content');
		});
