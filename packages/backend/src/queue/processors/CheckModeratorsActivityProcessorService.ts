...
function generateModeratorInactivityMail(remainingTime: ModeratorInactivityRemainingTime) {
	...
	const message = [
		...
		'If you do not wish to move to invitation only, you must log into Acuaskey and update your last active date and time.',
		'',
		'---------------',
		'',
		'To モデレーター各位',
		...
		'招待制に切り替わることを望まない場合は、Acuaskeyにログインして最終アクティブ日時を更新してください。',
		'',
		'---------------',
		'',
		'To 모더레이터 여러분께',
		...
		'초대제로 전환을 원하지 않는 경우, Acuaskey에 로그인하여 마지막 활성 날짜를 업데이트해 주세요.',
		'',
	];
