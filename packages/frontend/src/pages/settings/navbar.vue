...
<div class="_gaps_m">
	...
	<MkRadios v-model="bannerDisplay">
		<template #label>{{ i18n.ts.displayBanner }} <span class="_beta" style="vertical-align: middle;">Acuaskey</span></template>
	...
	<FormSection>
		<template #label>{{ i18n.ts.bottomNavbar }} <span class="_beta" style="vertical-align: middle;">Acuaskey</span></template>
