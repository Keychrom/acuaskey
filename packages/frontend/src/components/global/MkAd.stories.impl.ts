...
export const Square = {
	...
	args: {
		...
		specify: {
			...
			place: 'square',
			imageUrl:
				'https://github.com/kokonect-link/Acuaskey/blob/master/packages/frontend/assets/about-icon.png?raw=true',
		},
	},
} satisfies StoryObj<typeof MkAd>;
export const Horizontal = {
	...
	args: {
		...
		specify: {
			...
			place: 'horizontal',
			imageUrl:
				'https://github.com/kokonect-link/Acuaskey/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		},
	},
} satisfies StoryObj<typeof MkAd>;
