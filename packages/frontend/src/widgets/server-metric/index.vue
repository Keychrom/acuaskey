...
<MkContainer :showHeader="widgetProps.showHeader" :naked="widgetProps.transparent">
	...
	<div v-if="meta" data-cy-mkw-serverMetric class="mkw-serverMetric">
		...
		<XCpuMemoryNetCompact v-else-if="widgetProps.view === 2" :connection="connection" :meta="meta"/>
		<XCpuMemoryCompact v-else-if="widgetProps.view === 3" :connection="connection" :meta="meta"/>
