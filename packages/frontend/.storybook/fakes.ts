...
export function channel(id = 'somechannelid', name = 'Some Channel', bannerUrl: string | null = 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/fedi.jpg?raw=true'): entities.Channel {
	return {
		id,
		createdAt: '2016-12-28T22:49:51.000Z',
...
export function file(isSensitive = false) {
	return {
		...
		url: 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		thumbnailUrl: 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		comment: null,
		folderId: null,
		folder: null,
		userId: null,
...
export function federationInstance(): entities.FederationInstance {
	return {
		...
		maintainerEmail: '',
		isSilenced: false,
		iconUrl: 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/about-icon.png?raw=true',
		faviconUrl: '',
		themeColor: '',
		infoUpdatedAt: '',
...
export function userLite(id = 'someuserid', username = 'cherrypikist', host: entities.UserDetailed['host'] = 'misskey-hub.net', name: entities.UserDetailed['name'] = 'Acuaskey User'): entities.UserLite {
	return {
		...
		avatarUrl: 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/about-icon.png?raw=true',
...
export function userDetailed(id = 'someuserid', username = 'cherrypikist', host: entities.UserDetailed['host'] = 'misskey-hub.net', name: entities.UserDetailed['name'] = 'Acuaskey User'): entities.UserDetailed {
	return {
		...
		bannerUrl: 'https://github.com/Keychrom/Acuaskey/blob/master/packages/frontend/assets/fedi.jpg?raw=true',
		birthday: '2014-06-20',
		createdAt: '2016-12-28T22:49:51.000Z',
