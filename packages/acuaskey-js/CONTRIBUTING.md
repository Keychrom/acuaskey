...
- Issueを質問に使わないでください。
	...
	- 質問は、[GitHub Discussions](https://github.com/kokonect-link/acuaskey/discussions)や[Discord](https://discord.gg/V8qghB28Aj)でお願いします。
...
- [`CHANGELOG_acuaskey.md`](/CHANGELOG_acuaskey.md)に変更点を追記してください。リファクタリングなど、利用者に影響を与えない変更についてはこの限りではありません。
