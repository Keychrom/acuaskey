# acuaskey.js
**Strongly-typed official acuaskey SDK for browsers/Node.js.**
...
[![NPM](https://nodei.co/npm/acuaskey-js.png?downloads=true&downloadRank=true&stars=true)](https://www.npmjs.com/package/acuaskey-js)

JavaScript(TypeScript)用の公式acuaskeySDKです。ブラウザ/Node.js上で動作します。
...
``` ts
import { api as misskeyApi } from 'acuaskey-js';
```
...
## Streaming
acuaskey.jsのストリーミングでは、二つのクラスが提供されます。
...
``` ts
const stream = new Misskey.Stream('https://acuaskey.test', { token: 'TOKEN' });
...
<div align="center">
	<a href="https://github.com/kokonect-link/acuaskey/blob/develop/CONTRIBUTING.md"><img src="https://assets.misskey-hub.net/public/i-want-you.png" width="300"></a>
</div>
